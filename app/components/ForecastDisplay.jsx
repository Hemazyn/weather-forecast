          ...
          <div className="bg-gray-700 text-white p-4 rounded-md mt-8 shadow-inner">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {list.map((forecast, index) => (
                         <div key={index} className="bg-gray-800 p-4 rounded-md shadow-md flex flex-col gap-4">
                              <p className="text-end text-xs text-gray-400">{convertTimeTo12HourFormat(forecast.dt)}</p>
