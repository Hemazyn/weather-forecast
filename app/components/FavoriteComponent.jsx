...
const FavoriteComponent = ({ favoriteCount, isExpanded, toggleExpanded, favoriteCities, handleRemoveFavorite }) => {
                                                       ...
                                                       {city.weather && city.weather.length > 0 && (
                                                            <div className="flex items-center">
                                                                 ...
                                                                 <div className="flex flex-col">
                                                                      ...
                                                                      <p className="text-lg">{unit === 'metric' ? `${Math.round(city.main.temp)}°C` : `${Math.round(city.main.temp)}°F`}</p>
                                                                 </div>
                                                            </div>
                                                       )}
                                                  </div>
