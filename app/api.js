...
//      try {
//           const response = await axios.delete(`${BASE_URL}/favoriteCities/${cityName}`);
//           return response.data;
//      } catch (error) {
...
export const addFavoriteCity = async (cityName) => {
     try {
          const response = await axios.post(`${API_URL}/favoriteCities`, { cityName });
          return response.data;
     } catch (error) {
          console.error('Error adding favorite city:', error);
          throw error;
...
// export const deleteFavoriteCity = async (cityName) => {
//      try {
//           const response = await axios.delete(`${API_URL}/favoriteCities/${encodeURIComponent(cityName)}`);
//           return response.data;
//      } catch (error) {
//           console.error('Error deleting favorite city:', error);
//           throw error;
